...
def login_page(request): 
    ...
    if request.method == 'POST':
        ...
        try :
            teamleader = Employe.objects.get(email_address = emp_email, phone_number = emp_num,is_leader = True)
...
def emplogin_page(request): 
    ...
    if request.method == 'POST':
        ...
        try :
            employe = Employe.objects.get(email_address = emp_email, phone_number = emp_num,is_leader = False)
